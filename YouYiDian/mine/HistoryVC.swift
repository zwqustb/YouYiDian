...
class HistoryVC: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tableView.register(UINib.init(nibName: "HistoryCell", bundle: nil), forCellReuseIdentifier: "reuseIdentifier")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setData(m_aryData![indexPath.row] as! NSDictionary)
        // Configure the cell...
